...
//topics file
var SignupSignin = require('./services/SignupSignin')
    ...
    consumer.on('message', function (message) {
        ...
        switch (topic_name) {
            ...
            case 'loginSignuptopic':
                buyerSignup.loginSignupService(data.data, function (err, res) {
                    console.log("app.js")
...
handleTopicRequest("loginSignuptopic", buyerSignup);
