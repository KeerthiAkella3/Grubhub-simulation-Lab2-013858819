...
router.post('/restaurantMenu',  function (req, res) {
  ...
  var addMenuItemQuery = [];
    ...
    kafka.make_request('restaurantMenu', { "path": "addMenuItem", "restaurantId": restaurantId, "sectionName":req.body.menuItemSection,"body": req.body , "itemData":menuItemAddData}, function (err, result) {
