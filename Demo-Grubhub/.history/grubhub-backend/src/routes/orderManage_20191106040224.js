...
router.post('/postOrder',requireAuth, function (req, res) {
...
router.get('/getBuyerOrder',requireAuth, function(req, res) {
...
router.get('/restaurantOrders',requireAuth, function(req, res) {
    console.log(req.query);
...
router.delete('/deleteOrder',requireAuth, function(req, res) {
    console.log(req.query);
...
router.post('/updateOrder',requireAuth, function(req,res) {
    console.log(req);
    let uniqueOrderId = req.body.uniqueOrderId;
    let newStatus = req.body.nextStatus;
    kafka.make_request('ordersTopic', {
