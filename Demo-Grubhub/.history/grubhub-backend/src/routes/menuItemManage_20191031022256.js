...
router.get('/menu', function (req, res) {
  ...
  const getMenu = async () => {
    kafka.make_request('restaurantMenu',{"path":"menuSection", "restaurantId": restaurantIdINT, "body": req.body}, function(err,result){
    let getSectionsResult = result;    //let getSectionsResult = await LoginSignUpDBObj.getSections("restaurantSectionTable");
    console.log("result from menuSection")
    console.log(result)
    ...
    kafka.make_request('restaurantMenu',{"path":"menu", "restaurantId": restaurantIdINT, "body": req.body}, function(err,result){
      let getMenuResult = result;    //let getSectionsResult = await LoginSignUpDBObj.getSections("restaurantSectionTable");
   // let getMenuResult = await LoginSignUpDBObj.getMenu("restaurantMenuTable", req.query.restaurantId);
   console.log("result from menu")
    console.log(result)
    if (getMenuResult) {
    ...
    kafka.make_request('restaurantMenu',{"path":"restaurantDetails", "restaurantId": restaurantIdINT, "body": req.body}, function(err,result){
      let getRestaurantDetails = result;
    console.log("result from restaurantDetails")
    console.log(result)
    ...
    if (getRestaurantDetails !== undefined) {
      ...
      if (detailsResult) {
        restaurantDetails = {
          ...
          restaurantEmailId: detailsResult.restaurantEmail,
