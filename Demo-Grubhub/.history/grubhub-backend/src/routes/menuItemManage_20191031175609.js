...
router.get('/menu', function (req, res) {
  ...
  //console.log(res)
  const getMenu = async () => {
    kafka.make_request('restaurantMenu', { "path": "getSection", "restaurantId": restaurantIdINT, "body": req.body }, function (err, result) {
      console.log("result from /menu in menu item manage")
      console.log(result)
      let getSectionsResult = result;
