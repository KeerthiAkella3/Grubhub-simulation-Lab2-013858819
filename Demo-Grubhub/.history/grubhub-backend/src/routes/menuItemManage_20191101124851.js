...
router.get('/menu', requireAuth,function (req, res) {
  let menuList = [];
  let sectionsResult = [];
  ...
  const getMenu = async () => {
    ...
    kafka.make_request('restaurantMenu', { "path": "getMenu", "restaurantId": restaurantIdINT, "body": req.body }, function (err, result) {
    ...
    kafka.make_request('restaurantMenu', { "path": "restaurantDetails", "restaurantId": restaurantId, "body": req.body }, function (err, result) {
      console.log("result from restaurantDetails in menu item manage")
      console.log(result)
      let getRestaurantDetails = result
...
router.post('/restaurantMenu',requireAuth, function (req, res) {
  ...
  const addMenuItem = async () => {
    kafka.make_request('restaurantMenu', { "path": "addMenuItem", "restaurantId": restaurantId, "body": req.body }, function (err, result) {
...
router.delete('/restaurantMenu',requireAuth, function (req, res) {
  ...
  const deleteMenuItem = async () => {
    kafka.make_request('restaurantMenu', { "path": "deleteMenuItem", "restaurantId": restaurantId, "body": req.body }, function (err, result) {
...
router.post('/restaurantSection',requireAuth, function (req, res) {
 ...
 // let sectionName = req.body.sectionName;
  ...
  const addSection = async () => {
    kafka.make_request('loginSignuptopic',{"path":"addSection", "restaurantId": restaurantId, "body": req.body}, function(err,result){
